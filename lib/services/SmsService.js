...
var SmsService = (function () {
    ...
    SmsService.prototype.getSms = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.httpClient.get("".concat(this.basePath, "/send/").concat(request.messageID, "/recipients/").concat(request.recipientID))];
                    case 1: return [2, (_a.sent()).data];
                    case 2:
                        err_3 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.httpClient.get("".concat(this.basePath, "/received/").concat(replyID))];
