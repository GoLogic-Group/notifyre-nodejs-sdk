...
exports.EventType = exports.ListSmsRequestStatusTypes = exports.ListSentFaxesRequestStatusTypes = exports.Sort = exports.FileType = exports.RecipientType = exports.ContentType = void 0;
var ContentType;
...
(function (ListSentFaxesRequestStatusTypes) {
    ListSentFaxesRequestStatusTypes["Completed"] = "completed";
    ListSentFaxesRequestStatusTypes["Draft"] = "draft";
    ListSentFaxesRequestStatusTypes["Failed"] = "failed";
    ListSentFaxesRequestStatusTypes["Warning"] = "warning";
...
(function (ListSmsRequestStatusTypes) {
    ListSmsRequestStatusTypes["Completed"] = "completed";
    ListSmsRequestStatusTypes["Draft"] = "draft";
    ListSmsRequestStatusTypes["Failed"] = "failed";
    ListSmsRequestStatusTypes["Warning"] = "warning";
    ListSmsRequestStatusTypes["Queued"] = "queued";
